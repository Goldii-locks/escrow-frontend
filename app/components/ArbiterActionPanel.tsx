...
export interface ArbiterActionPanelProps {
  /** Zero-based milestone index under dispute. Displayed one-based. */
 ...
 * from `sm:` upward.
 */
export default function ArbiterActionPanel({
  milestoneIndex,
  displayAmount = null,
  escrowAmount = null,
  onResolve,
  ...
  function handleSubmit() {
    ...
    if (!result.valid || outcome === null) return;
  ...
  return (
    <section
      ...
      aria-busy={isPending}
      className={`${ARBITER_PANEL_CLASSES.container} ${className}`}
    >
      ...
      {panelError && (
        <div
          ...
          className={ARBITER_PANEL_CLASSES.alert}
        >
          {panelError}
        </div>
      )}
      ...
      >
        ...
        {fieldErrors.outcome && (
          <p
            ...
            className={`mt-1 ${ARBITER_PANEL_CLASSES.fieldError}`}
          >
            {fieldErrors.outcome}
          </p>
        )}
      ...
      <div>
        ...
        {fieldErrors.confirmation && (
          <p
            ...
            className={ARBITER_PANEL_CLASSES.fieldError}
          >
            {fieldErrors.confirmation}
          </p>
        )}
      ...
      <div
        ...
        className={ARBITER_PANEL_CLASSES.actions}
      >
        <button
          type="button"
      ...
      {resolveState && resolveState.phase !== "idle" && (
        <div data-testid="arbiter-panel-status">
          <TxStatusBanner
            state={resolveState}
